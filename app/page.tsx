    ...
    <main className="min-h-screen overflow-x-hidden" style={{ background: "var(--paper)" }}>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          <KofiButton size="md" />
          <a
            href="https://github.com/Varshithvhegde/postitup/issues"
            target="_blank"
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLElement).style.boxShadow = "3px 4px 0 rgba(28,28,28,0.14)"; }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ""; (e.currentTarget as HTMLElement).style.boxShadow = "2px 2px 0 rgba(28,28,28,0.1)"; }}
          >
